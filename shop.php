                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class='single-product-wrapper'>
                                    ...
                                    <div class='product-img'>
                                        <img src='admin/uplode/{$row['product_image']}' alt=''>
                                        <!-- Hover Thumb -->
                                        <img class='hover-img' src='admin/uplode/{$row['product_image']}' alt=''>
                                    ...
                                    echo "<div class='product-description'>
                                        ...
                                        <div class='hover-content'>
                                            ...
                                            <div class='add-to-cart-btn'>
                                                <form method='post'><a href='#' name='addtocat' class='btn essence-btn'>Add to Cart</a></form>'";
